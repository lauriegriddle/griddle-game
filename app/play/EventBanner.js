  ...
  return (
    <div className="max-w-lg mx-auto mb-3 mt-1">
      <a
        ...
        className="block rounded-xl overflow-hidden shadow-lg border border-amber-400 transition-all hover:shadow-xl"
        style={{
          background: "linear-gradient(135deg, #fef3c7 0%, #fde68a 50%, #fcd34d 100%)"
        }}
      >
        <div className="px-4 py-3 text-center">
          <p className="text-amber-900 text-xs font-semibold tracking-wide uppercase mb-1">
          ...
          <p
            className="text-amber-700 text-xs italic mt-2"
            style={{ fontFamily: "Georgia, serif" }}
          >
            Ongoing all weekend ~ All sessions available!
          </p>
          <p className="text-amber-900 text-xs font-bold mt-2 tracking-wide">
            Join Here
          </p>
        </div>
      </a>
