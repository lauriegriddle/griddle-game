...
const ALL_QUESTIONS = [
  ...
  { q: "Which country is both in Europe and Asia?", a: "Both Russia and Turkey", wrong: ["Russia","Turkey","Egypt"], cat: "Geography", fact: "Both Russia and Turkey span two continents. Istanbul, Turkey is the only major city in the world located on two continents!" },
  ...
  { q: "What is the only food that never expires?", a: "All of the above", wrong: ["Vinegar","Salt","Honey"], cat: "Fun Facts", fact: "Honey, salt, and pure distilled white vinegar all have an indefinite shelf life when stored properly! Salt never expires because it is a mineral. Vinegar is self-preserving due to its acidity. And honey's natural properties keep it fresh for millennia." },
  ...
  { q: "What is the shortest complete sentence in the English language?", a: "Go.", wrong: ["I am.","Be.","Hi."], cat: "Words & Language", fact: "The shortest grammatically complete sentence in English is 'Go.' It is a command where the subject 'you' is implied. 'I am.' is the shortest sentence with an explicit subject and verb. English is remarkable for how much meaning can be packed into two letters!" },

  // Original prototype questions
  { q: "What gas do plants absorb during photosynthesis?", a: "Carbon dioxide", wrong: ["Oxygen","Nitrogen","Hydrogen"], cat: "Science", fact: "Plants convert CO2 and water into glucose using sunlight, the fuel that powers most life on Earth." },
  { q: "How many sides does a hexagon have?", a: "Six", wrong: ["Five","Seven","Eight"], cat: "Math", fact: "Honeybees build hexagonal cells because they are the most space-efficient shape for storing honey." },
  { q: "What year did the first humans land on the moon?", a: "1969", wrong: ["1965","1971","1973"], cat: "History", fact: "Apollo 11 landed on July 20, 1969. Neil Armstrong stepped onto the lunar surface at 10:56 PM EDT." },
  { q: "Which fruit is known as the king of fruits?", a: "Durian", wrong: ["Mango","Jackfruit","Papaya"], cat: "Food & Drink", fact: "Durian is beloved in Southeast Asia for its rich custard-like flesh, though its pungent smell is banned on many transit systems." },
  { q: "What is the hardest natural substance on Earth?", a: "Diamond", wrong: ["Quartz","Corundum","Topaz"], cat: "Science", fact: "Diamonds score a perfect 10 on the Mohs hardness scale and form under intense heat and pressure deep in the Earth's mantle." },
  { q: "How many bones does an adult human have?", a: "206", wrong: ["212","198","225"], cat: "Science", fact: "Babies are born with about 270 bones. Many fuse together during childhood and adolescence leaving us with 206 as adults." },
  { q: "Which ancient wonder of the world still exists?", a: "Great Pyramid of Giza", wrong: ["Hanging Gardens","Colossus of Rhodes","Temple of Artemis"], cat: "History", fact: "Built around 2560 BCE, the Great Pyramid stood as the tallest human-made structure on Earth for over 3,800 years." },
  { q: "What color is a polar bear's fur, actually?", a: "Transparent and hollow", wrong: ["Pure white","Pale yellow","Creamy blue"], cat: "Science", fact: "Each strand of polar bear fur is hollow and transparent. It only appears white because it scatters visible light." },
  { q: "Which country invented pasta?", a: "China", wrong: ["Italy","Greece","Persia"], cat: "Food & Drink", fact: "Noodles were enjoyed in China at least 4,000 years ago, long before pasta became a staple of Italian cuisine." },
  { q: "How long is a day on Venus in Earth hours?", a: "5,832 hours", wrong: ["2,800 hours","743 hours","10,000 hours"], cat: "Space", fact: "Venus rotates so slowly that a single Venusian day is longer than its entire year." },
  { q: "What does NASA stand for?", a: "National Aeronautics and Space Administration", wrong: ["National Aerospace Science Agency","North American Space Association","National Aviation and Space Affairs"], cat: "Space", fact: "NASA was established in 1958 and has overseen every U.S. human spaceflight program." },
  { q: "What ingredient makes bread rise?", a: "Yeast", wrong: ["Baking soda","Salt","Sugar"], cat: "Food & Drink", fact: "Yeast consumes sugars and produces carbon dioxide gas, which creates the air pockets that make bread fluffy." },
  { q: "On what continent is the Sahara Desert?", a: "Africa", wrong: ["Asia","South America","Australia"], cat: "Geography", fact: "The Sahara is the world's largest hot desert, covering about 3.6 million square miles across northern Africa." },
  { q: "How many colors are in a rainbow?", a: "Seven", wrong: ["Five","Six","Eight"], cat: "Science", fact: "The seven colors are red, orange, yellow, green, blue, indigo, and violet, often remembered as ROY G BIV." },
  { q: "What metal is liquid at room temperature?", a: "Mercury", wrong: ["Gallium","Cesium","Francium"], cat: "Science", fact: "Mercury is the only metal that is liquid at standard room temperature, which is why it was once used in thermometers." },
  ...
  { q: "How long does it take light from the Sun to reach Earth?", a: "About 8 minutes", wrong: ["About 8 seconds","About 8 hours","About 8 days"], cat: "Space", fact: "Sunlight takes about 8 minutes and 20 seconds to travel the 93 million miles to Earth. This means we always see the Sun as it was 8 minutes ago." },
  { q: "What is the only mammal native to Antarctica?", a: "There are none", wrong: ["Polar bear","Arctic fox","Snow leopard"], cat: "Animals", fact: "No land mammals are native to Antarctica! Penguins, seals, and whales visit or live in its waters, but polar bears live in the Arctic. The two poles are on opposite ends of the Earth." },
  ...
  // Sports trivia
  { q: "How many players are on a standard soccer team on the field?", a: "11", wrong: ["9","10","12"], cat: "Sports", fact: "Each soccer team fields 11 players including the goalkeeper. The sport is played in over 200 countries, making it the most popular sport in the world by participation." },
  { q: "How long is a standard NBA basketball game?", a: "48 minutes", wrong: ["40 minutes","60 minutes","36 minutes"], cat: "Sports", fact: "NBA games consist of four 12-minute quarters. However, with timeouts, fouls, and stoppages, the actual broadcast time is typically around 2 to 2.5 hours!" },
  { q: "What country invented basketball?", a: "Canada", wrong: ["United States","England","France"], cat: "Sports", fact: "Basketball was invented in 1891 by Canadian-American Dr. James Naismith in Springfield, Massachusetts. He nailed peach baskets to an elevated track and wrote 13 basic rules, most of which still apply today!" },
  { q: "How many holes are in a standard round of golf?", a: "18", wrong: ["9","12","24"], cat: "Sports", fact: "A standard round of golf has 18 holes, a tradition that dates to St Andrews in Scotland in 1764. Before that, courses had varying numbers of holes ranging from 5 to 25!" },
  { q: "What is the diameter of a basketball hoop?", a: "18 inches", wrong: ["15 inches","20 inches","16 inches"], cat: "Sports", fact: "The basketball rim has an 18-inch diameter, exactly twice the diameter of a standard NBA basketball (9.4 inches). This means two basketballs can theoretically fit side by side through the hoop at the same time!" },
  { q: "In tennis, what is the term for winning a game with no points scored by the opponent?", a: "Love game", wrong: ["Bagel","Clean game","Whitewash"], cat: "Sports", fact: "In tennis, 'love' means zero. A love game means the server won without giving the opponent a single point. The word likely comes from the French 'l'oeuf' meaning egg, which resembles a zero!" },
  { q: "How many points is a touchdown worth in American football?", a: "6", wrong: ["7","5","8"], cat: "Sports", fact: "A touchdown is worth 6 points, and teams then attempt a point-after kick (1 point) or two-point conversion. Touchdowns were worth 4 points when first introduced in 1883!" },
  { q: "What country has won the most FIFA World Cup titles?", a: "Brazil", wrong: ["Germany","Italy","Argentina"], cat: "Sports", fact: "Brazil has won the FIFA World Cup five times: 1958, 1962, 1970, 1994, and 2002. They are also the only nation to have participated in every World Cup since its inception in 1930!" },
  { q: "How many innings are in a standard Major League Baseball game?", a: "9", wrong: ["7","8","10"], cat: "Sports", fact: "A standard MLB game has 9 innings. The longest game in professional baseball history lasted 33 innings in 1981 between the Pawtucket Red Sox and Rochester Red Wings, played over two days!" },
  { q: "What is the only sport that has been played on the moon?", a: "Golf", wrong: ["Tennis","Baseball","Javelin"], cat: "Sports", fact: "Apollo 14 astronaut Alan Shepard famously hit two golf balls on the moon in 1971 using a makeshift club. He claimed one ball traveled for miles in the low lunar gravity!" },
  { q: "How high is an Olympic diving platform?", a: "10 meters", wrong: ["8 meters","12 meters","15 meters"], cat: "Sports", fact: "The highest Olympic diving platform stands 10 meters (about 33 feet) above the water. Divers hit the water at speeds of around 35 miles per hour, entering in under a second!" },
  { q: "What sport uses a shuttlecock?", a: "Badminton", wrong: ["Squash","Pickleball","Table tennis"], cat: "Sports", fact: "Badminton uses a shuttlecock, also called a birdie, which can travel at over 200 mph in professional play making it the fastest projectile in any racquet sport!" },
  { q: "How many players are on a volleyball team on the court?", a: "6", wrong: ["5","7","8"], cat: "Sports", fact: "Volleyball teams field 6 players per side. The sport was invented in 1895 by William Morgan in Massachusetts just four years after basketball as a less physically intense alternative." },
  { q: "What is the maximum score in a single game of bowling?", a: "300", wrong: ["270","360","250"], cat: "Sports", fact: "A perfect bowling score is 300, achieved by rolling 12 consecutive strikes. The odds of a professional bowler rolling a perfect game are roughly 1 in 460!" },
  { q: "Which country has won the most Olympic gold medals in history?", a: "United States", wrong: ["Soviet Union","China","Germany"], cat: "Sports", fact: "The United States has won the most Olympic gold medals in history with over 1,000 golds across Summer and Winter Games combined. They have participated in every Summer Olympics except 1980." },
  { q: "How long is a marathon?", a: "26.2 miles", wrong: ["24 miles","25 miles","28 miles"], cat: "Sports", fact: "The modern marathon distance of 26.2 miles was standardized at the 1908 London Olympics when the course was extended to finish in front of the Royal Box. The extra 0.2 miles came from the royal family's viewing preference!" },
  { q: "In what year were women first allowed to compete in the Olympic Games?", a: "1900", wrong: ["1924","1912","1896"], cat: "Sports", fact: "Women first competed in the Olympics at the 1900 Paris Games in tennis and golf. Only 22 of the 997 athletes were women. Today women make up nearly half of all Olympic participants." },
  { q: "What is the national sport of Canada?", a: "Lacrosse and ice hockey", wrong: ["Ice hockey only","Curling","Lacrosse only"], cat: "Sports", fact: "Canada officially has two national sports: lacrosse as the national summer sport and ice hockey as the national winter sport. Lacrosse was actually recognized as a national sport first in 1859!" },
  { q: "How many dimples are on a regulation golf ball?", a: "Between 300 and 500", wrong: ["Exactly 100","Exactly 200","Between 500 and 700"], cat: "Sports", fact: "Golf balls typically have between 300 and 500 dimples, with 336 being a common number. The dimples create turbulence that reduces drag and helps the ball travel up to twice as far as a smooth ball would!" },
  { q: "What sport is played at Wimbledon?", a: "Tennis", wrong: ["Croquet","Bowls","Squash"], cat: "Sports", fact: "Wimbledon is the oldest and most prestigious tennis tournament in the world, held annually since 1877 in London. It is the only Grand Slam still played on grass courts and famously requires players to wear predominantly white!" },
];
...
export default function ChroniclesPage() {
  ...
  useEffect(() => {
    setHasMounted(true);
    try {
      const saved = localStorage.getItem('chroniclesStats');
  ...
  const saveStats = useCallback((newStats) => {
    setStats(newStats);
    try { localStorage.setItem('chroniclesStats', JSON.stringify(newStats)); } catch (e) {}
  }, []);
  ...
  const advanceOrFinish = () => {
    if (idx + 1 < questions.length) {
      ...
      const newStreak = stats.lastPlayedDate === yesterday || stats.lastPlayedDate === today
  ...
  const handleShare = async () => {
    ...
    const text = [
      ...
      '',
      'Play at lettergriddle.com/chronicles',
  ...
  const S = {
    page: { background: '#12102a', minHeight: '100vh', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '20px 16px 40px', fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", color: '#f0e6c8', position: 'relative' },
    card: { width: '100%', maxWidth: '520px', background: '#1c1838', border: '1px solid rgba(212,134,14,0.28)', borderRadius: '20px', overflow: 'hidden', position: 'relative', zIndex: 1, boxShadow: '0 0 60px rgba(120,80,200,0.12), 0 20px 60px rgba(0,0,0,0.5)', marginTop: '8px' },
    strip: { height: '4px', background: 'linear-gradient(90deg, #7c5cbf, #f5c842, #7c5cbf)' },
    screen: { padding: '28px 24px' },
    badge: { display: 'inline-block', fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', color: '#c09ef5', background: 'rgba(124,92,191,0.15)', border: '1px solid rgba(200,180,255,0.15)', padding: '4px 14px', borderRadius: '20px', marginBottom: '12px' },
    title: { fontFamily: "'Special Elite', serif", fontSize: '30px', color: '#f5c842', letterSpacing: '1px', lineHeight: '1.1', marginBottom: '6px', textAlign: 'center' },
    subtitle: { fontSize: '13px', color: '#9e8f72', lineHeight: '1.5', textAlign: 'center', marginBottom: '24px' },
    loreBox: { background: 'rgba(124,92,191,0.08)', border: '1px solid rgba(200,180,255,0.15)', borderRadius: '10px', padding: '14px 16px', marginBottom: '22px', fontSize: '13px', color: '#9e8f72', lineHeight: '1.6' },
    sectionLabel: { fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', color: '#9e8f72', marginBottom: '10px' },
    optBtn: (active) => ({ background: active ? 'rgba(212,134,14,0.15)' : '#261e4a', border: `1px solid ${active ? '#f5c842' : 'rgba(212,134,14,0.28)'}`, color: active ? '#f5c842' : '#9e8f72', padding: '9px 16px', borderRadius: '8px', cursor: 'pointer', fontSize: '13px', transition: 'all 0.18s' }),
    startBtn: { width: '100%', padding: '15px', background: 'linear-gradient(135deg, #c4780a, #f5c842)', color: '#0e0c1e', border: 'none', borderRadius: '11px', fontFamily: "'Special Elite', serif", fontSize: '17px', letterSpacing: '1px', cursor: 'pointer', boxShadow: '0 4px 20px rgba(212,134,14,0.25)' },
    hud: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '18px', paddingBottom: '16px', borderBottom: '1px solid rgba(212,134,14,0.18)' },
    hudVal: { fontFamily: "'Special Elite', serif", fontSize: '24px', color: '#f5c842', lineHeight: 1 },
    hudLabel: { fontSize: '11px', color: '#9e8f72', marginTop: '3px' },
    progressWrap: { height: '3px', background: '#261e4a', borderRadius: '2px', marginBottom: '22px', overflow: 'hidden' },
    qNum: { fontSize: '11px', color: '#9e8f72', letterSpacing: '1px', textTransform: 'uppercase', marginBottom: '6px' },
    qCat: { display: 'inline-block', background: 'rgba(124,92,191,0.18)', border: '1px solid rgba(200,180,255,0.15)', color: '#c09ef5', fontSize: '11px', padding: '3px 12px', borderRadius: '20px', marginBottom: '12px' },
    qText: { fontSize: '18px', lineHeight: '1.55', color: '#f0e6c8', marginBottom: '22px', minHeight: '56px' },
    choiceBtn: (state) => {
      if (state === 'correct') return { background: 'rgba(76,175,125,0.15)', border: '1px solid rgba(76,175,125,0.5)', color: '#8ef5bc' };
      if (state === 'wrong') return { background: 'rgba(224,82,82,0.12)', border: '1px solid rgba(224,82,82,0.4)', color: '#f5aaaa' };
      return { background: '#261e4a', border: '1px solid rgba(212,134,14,0.28)', color: '#f0e6c8' };
    },
    factBox: (state) => ({
      borderRadius: '10px', padding: '13px 15px', fontSize: '13px', lineHeight: '1.55',
      marginBottom: '14px', minHeight: '48px', transition: 'all 0.25s',
      ...(state === 'correct' ? { background: 'rgba(76,175,125,0.1)', border: '1px solid rgba(76,175,125,0.5)', color: '#a0f0c8' }
        : state === 'wrong' ? { background: 'rgba(224,82,82,0.08)', border: '1px solid rgba(224,82,82,0.4)', color: '#f0b0b0' }
        : { background: '#261e4a', border: '1px solid rgba(212,134,14,0.18)', color: '#9e8f72' }),
    }),
    nextBtn: { width: '100%', padding: '12px', background: '#261e4a', border: '1px solid rgba(212,134,14,0.28)', color: '#f0e6c8', borderRadius: '9px', cursor: 'pointer', fontSize: '14px', transition: 'all 0.2s' },
    recapScore: { fontFamily: "'Special Elite', serif", fontSize: '52px', color: '#f5c842', lineHeight: 1 },
    statCard: { flex: 1, background: '#261e4a', border: '1px solid rgba(212,134,14,0.18)', borderRadius: '10px', padding: '14px 10px', textAlign: 'center' },
    statN: { fontFamily: "'Special Elite', serif", fontSize: '28px', color: '#f5c842' },
    statL: { fontSize: '11px', color: '#9e8f72', marginTop: '3px' },
    legendMsg: { background: 'rgba(124,92,191,0.1)', border: '1px solid rgba(200,180,255,0.15)', borderRadius: '10px', padding: '13px 18px', fontSize: '14px', color: '#c09ef5', fontStyle: 'italic', textAlign: 'center', marginBottom: '18px', lineHeight: '1.5' },
    travelogue: { background: '#12102a', border: '1px solid rgba(212,134,14,0.18)', borderRadius: '12px', overflow: 'hidden', marginBottom: '18px' },
    travelogueHeader: { background: '#1c1838', borderBottom: '1px solid rgba(212,134,14,0.18)', padding: '11px 16px', fontFamily: "'Special Elite', serif", fontSize: '13px', color: '#d4860e' },
    footer: { textAlign: 'center', padding: '20px 22px 24px', borderTop: '1px solid rgba(212,134,14,0.18)', marginTop: '4px' },
  };
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        {stars.map(star => (
          <div key={star.id} style={{
            ...
            background: '#e8d5a3', borderRadius: '50%', opacity: 0,
          ...
          {view === 'setup' && (
            <div style={S.screen}>
              <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                <div style={S.badge}>Year 2126 · Time Capsule Edition</div>
                <div style={S.title}>Griddle Chronicles</div>
                <div style={S.subtitle}>Preserve the trivia for generations of cafe regulars</div>
                <div style={{ fontSize: '28px', letterSpacing: '4px', opacity: 0.8, margin: '16px 0' }}>☕ 📖 🌌</div>
              </div>
              ...
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '22px' }}>
                {[3, 5, 7, 10].map(n => (
                  <button key={n} onClick={() => setQCount(n)} style={S.optBtn(qCount === n)}>{n} questions</button>
                ))}
              </div>

              <div style={S.sectionLabel}>Time limit</div>
              <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '22px' }}>
                {[{ s: 30, l: '30s' }, { s: 60, l: '1 min' }, { s: 90, l: '90s' }, { s: 120, l: '2 min' }].map(t => (
                  <button key={t.s} onClick={() => setTimeLimitSec(t.s)} style={S.optBtn(timeLimitSec === t.s)}>{t.l}</button>
                ))}
              </div>

              <hr style={{ border: 'none', borderTop: '1px solid rgba(212,134,14,0.18)', margin: '6px 0 22px' }} />
              <button onClick={startGame} style={S.startBtn}>Open the Tome &rarr;</button>
            </div>
          )}
            ...
            <div style={S.screen}>
              ...
              <div style={S.hud}>
                <div style={{ textAlign: 'center', minWidth: '56px' }}>
                  <div style={S.hudVal}>{idx + 1}<span style={{ fontSize: '14px', color: '#9e8f72' }}>/{questions.length}</span></div>
                  <div style={S.hudLabel}>Entry</div>
                </div>
                ...
                <div style={{ position: 'relative', width: '64px', height: '64px' }}>
                  <svg width="64" height="64" viewBox="0 0 64 64" style={{ transform: 'rotate(-90deg)' }}>
                    ...
                    <circle cx="32" cy="32" r="27" fill="none" stroke={timerStroke} strokeWidth="5" strokeLinecap="round"
                      strokeDasharray={`${dash.toFixed(2)} ${circ.toFixed(2)}`} style={{ transition: 'stroke-dasharray 0.9s linear, stroke 0.3s' }} />
                  </svg>
                ...
                <div style={{ textAlign: 'center', minWidth: '56px' }}>
                  <div style={S.hudVal}>{results.filter(r => r.correct).length}</div>
                  <div style={S.hudLabel}>Preserved</div>
                </div>
              </div>
              ...
              <div style={S.qNum}>Entry {idx + 1} of {questions.length}</div>
              <div style={S.qCat}>{questions[idx].cat}</div>
              <div style={S.qText}>{questions[idx].q}</div>

              {/* Choices */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '14px' }}>
                {questions[idx]._opts.map((o, i) => {
                  const state = answered ? (o === questions[idx].a ? 'correct' : o === selected ? 'wrong' : 'dim') : 'default';
                  return (
              ...
              {/* Fact box */}
              <div style={S.factBox(answered ? (selected === questions[idx].a ? 'correct' : 'wrong') : 'default')}>
                {answered
          ...
          {view === 'recap' && (
            <div style={S.screen}>
              <div style={{ textAlign: 'center', marginBottom: '22px' }}>
                <div style={{ fontSize: '13px', color: '#9e8f72', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '10px' }}>Griddle Chronicles · Year 2126</div>
                <div style={S.recapScore}>{results.filter(r => r.correct).length}/{questions.length}</div>
              ...
              <div style={S.legendMsg}>&ldquo;{legend}&rdquo;</div>

              {/* Travelogue */}
              <div style={S.travelogue}>
                <div style={S.travelogueHeader}>📜 Your Travelogue · Session Record</div>
                <div style={{ padding: '12px 16px', maxHeight: '250px', overflowY: 'auto' }}>
                  {results.map((r, i) => {
                    const q = questions[i];
                    if (!q) return null;
                    const icon = r.timedOut ? '⏱' : r.correct ? '🍯' : '☕';
                    const dotColor = r.timedOut ? 'rgba(180,180,180,0.12)' : r.correct ? 'rgba(76,175,125,0.25)' : 'rgba(224,82,82,0.2)';
                    const dotText = r.timedOut ? '#aaa' : r.correct ? '#8ef5bc' : '#f5aaaa';
                    ...
                    return (
                      <div key={i} style={{ display: 'flex', gap: '10px', alignItems: 'flex-start', padding: '9px 0', borderBottom: i < results.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none' }}>
                        <div style={{ width: '22px', height: '22px', borderRadius: '50%', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '11px', marginTop: '1px', background: dotColor, color: dotText }}>{icon}</div>
                        <div>
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <button onClick={() => setView('setup')} style={{ flex: 1, padding: '13px', background: 'linear-gradient(135deg, #c4780a, #f5c842)', color: '#0e0c1e', border: 'none', borderRadius: '9px', fontFamily: "'Special Elite', serif", fontSize: '15px', cursor: 'pointer' }}>Play again</button>
          ...
          <div onClick={() => setShowStats(false)} style={{ position: 'fixed', inset: 0, zIndex: 50, background: 'rgba(18,16,42,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px' }}>
            <div onClick={e => e.stopPropagation()} style={{ background: '#1c1838', border: '1px solid rgba(212,134,14,0.28)', borderRadius: '16px', padding: '28px 24px', maxWidth: '320px', width: '100%', position: 'relative' }}>
              ...
              <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                ...
                <h2 style={{ fontFamily: "'Special Elite', serif", fontSize: '20px', color: '#f5c842' }}>Your Stats</h2>
              </div>
