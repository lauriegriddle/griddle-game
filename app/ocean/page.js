...
const ShareModal = ({ onClose }) => {
  ...
  const shareText = "\uD83C\uDF0A Ocean Adventure\n\uD83E\uDD88 Completed all 3 puzzles!\n\uD83D\uDC1A\uD83D\uDC1A\uD83D\uDC1A\nPlay at lettergriddle.com/ocean";
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div className="bg-gradient-to-br from-blue-950 to-slate-900 border border-cyan-500/30 rounded-xl p-5 max-w-sm w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-amber-200 font-semibold text-lg" style={{ fontFamily: "Cormorant Garamond, serif" }}>Share Ocean Adventure</h3>
          <button onClick={onClose} className="text-slate-400 hover:text-slate-200 transition-colors text-lg w-8 h-8 flex items-center justify-center rounded-full hover:bg-slate-700/50">{"\u2715"}</button>
        </div>
        <div className="bg-slate-900/60 border border-cyan-500/20 rounded-lg p-4 mb-4 whitespace-pre-line text-slate-200 text-sm" style={{ fontFamily: "Georgia, serif" }}>
          {shareText}
        </div>
        <button onClick={handleCopy} className="w-full px-6 py-2.5 rounded-full bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-500 hover:to-blue-600 text-white font-medium transition-all shadow-lg">
      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-950 via-slate-900 to-cyan-950 flex items-center justify-center p-4">
        ...
        <div className="max-w-lg w-full text-center">
          ...
          <div className="fade-up fade-up-2 mb-6">
            <button onClick={handleShareClick} className="px-6 py-2.5 rounded-full bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-500 hover:to-blue-600 text-white font-medium transition-all shadow-lg hover:scale-105" style={{ fontFamily: "Crimson Text, serif" }}>
              Share Ocean Adventure {"\uD83C\uDF0A"}
            </button>
          </div>
