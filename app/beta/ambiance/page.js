...
const AmbiancePage = () => {
  ...
  const [imageLoaded, setImageLoaded] = useState({ day: false, evening: false });
  const audioRef = useRef(null);

  // Track lists for day and evening
  const dayTracks = [
...
/>
      ...
      {/* Evening Image - Moody Window Cafe */}
      <div 
        className={`absolute inset-0 transition-opacity duration-1000 ${
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4">
          ...
          {/* Cafe Title - Styled like window signage */}
          ...
          >
            {isEvening 
              ? '"The best conversations happen at the cafe."' 
