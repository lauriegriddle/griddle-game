...
const AI_WORDS = [
  ...
  'FACED','FACES','FACTS','FAINT','FAIRY','FAITH','FALSE','FANCY','FARMS','FATAL','FAULT','FAVOR','FEARS','FEAST','FEELS','FENCE','FERRY','FEWER','FIBER','FIELD','FIFTH','FIFTY','FIGHT','FILED','FILES','FINAL','FINDS','FIRED','FIRES','FIRMS','FIRST','FIXED','FLAGS','FLAME','FLAPS','FLASH','FLASK','FLATS','FLESH','FLIES','FLOAT','FLOCK','FLOOD','FLOOR','FLOUR','FLOWS','FLUID','FLUSH','FLUTE','FOCUS','FOLKS','FOODS','FOOLS','FORCE','FORGE','FORMS','FORTH','FORTY','FORUM','FOSSIL','FOUND','FRAME','FRANK','FRAUD','FREED','FRESH','FRIED','FRONT','FROST','FRUIT','FULLY','FUNDS','FUNNY','FUZZY',
