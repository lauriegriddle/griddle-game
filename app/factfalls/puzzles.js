...
const FACTS = [
  ...
  { number:31, source:"Takeout",           text:"Romans sold fast food from stone street counters" },
  { number:32, source:"Friday",            text:"Casual Friday grew from Hawaiis Aloha Friday in the 1960s" },
  { number:33, source:"Kickball",          text:"Kickball was used to train soldiers in World War II" },
  { number:34, source:"Garlic",            text:"Garlic repels bugs and inspired myths about vampires" },
  { number:35, source:"Volunteers",        text:"Volunteers are far less likely to feel lonely or stressed" },
  { number:36, source:"Earth Day",         text:"Earth Day is observed by over one billion people worldwide" },
  { number:37, source:"Hot Tea",           text:"Turkey drinks more tea per person than any nation on Earth" },
  { number:38, source:"Shakespeare",       text:"Shakespeare coined over 1700 words including eyeball" },
  { number:39, source:"Penguins",          text:"Penguins fly underwater at speeds up to 22 miles per hour" },
  { number:40, source:"Getting Organized", text:"Being organized can save thousands of hours over a lifetime" },
  { number:41, source:"Superhero",         text:"Batman uses only his mind training and tools not superpowers" },
  { number:42, source:"Poetry",            text:"Poetry came before writing and helped preserve stories" },
  { number:43, source:"Animal Crackers",   text:"Early animal crackers included a string so kids could hang the box" },
  { number:44, source:"Barbecue",          text:"Barbecue comes from a Taino word meaning sacred fire pit" },
  { number:45, source:"April Showers",     text:"April showers bring May flowers is a line from a 1557 poem" },
  { number:46, source:"Hoagie",            text:"Philadelphia named the hoagie its official sandwich in 1992" },
  { number:47, source:"Shrimp",            text:"Shrimp hearts are located in their heads" },
  { number:48, source:"Cinco de Mayo",     text:"Mexico beat France at the Battle of Puebla in 1862" },
  { number:49, source:"Mothers Day",       text:"Mothers Day was created by Anna Jarvis in 1908" },
  { number:50, source:"Hat",               text:"Hats once showed a persons status job and religion at a glance" },
  { number:51, source:"Museum",            text:"The Louvre draws over ten million visitors every year" },
  { number:52, source:"Turtles",           text:"Turtles have lived on Earth for more than 150 million years" },
  { number:53, source:"Hamburger",         text:"Burgers make up about 60 percent of all sandwiches sold" },
  { number:54, source:"Blueberry",         text:"Blueberries are actually purple and packed with antioxidants" },
  { number:55, source:"Memorial Day",      text:"Memorial Day began as Decoration Day after the Civil War" },
  { number:56, source:"Sunscreen",         text:"Reapply sunscreen every 40 to 80 minutes for full protection" },
  { number:57, source:"Mint",              text:"Mint makes your mouth feel cold without changing its temperature" },
  { number:58, source:"Outdoors",          text:"Being in nature lowers stress hormones in the body" },
  { number:59, source:"Coconut",           text:"The coconut palm is known as the Tree of Life" },
  { number:60, source:"Ladybug",           text:"Ladybugs can smell with their feet" },
];
        ...
        {grid.map((row,r)=>(
          <tr key={r}>
            {row.map((cell,c)=>{
              const key=`${r},${c}`;
              if (cell.t==='b') return (
                <td key={c} style={{height:'36px',background:'#412402',border:'none'}}/>
              );
              return (
                <td key={c}
                  onClick={()=>started && onFocus(key)}
                  style={{height:'36px',border:'none',boxShadow:'inset 0 0 0 1.5px #EF9F27',padding:0,position:'relative',
